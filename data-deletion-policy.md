...
### 2.1 Organizer Data
If you organized sessions that other players attended, basic session history (e.g., venue, date) may be retained for bookkeeping and fraud prevention. Personal identifiers are removed or anonymized.

---

## 3. Deletion Timeline
- We aim to complete deletion within **30 days** of receiving a verified request.
- Some residual data may remain in encrypted backups for up to **90 days** due to automated backup cycles. Once the retention period expires, backups are purged automatically.

---

## 4. Data We May Retain
We may retain limited information where required by law or legitimate business needs, including:
- Financial records and transaction logs needed for accounting, dispute resolution, or regulatory compliance (typically retained for up to 7 years depending on jurisdiction).
- Fraud prevention data and access logs needed to protect the platform and other users.
- Aggregated or anonymized analytics data that does not identify you.

---

## 5. Reinstating an Account
Once deletion is complete, the process is irreversible. If you wish to use Game Match again, you must create a new account.
...
We may update this policy to reflect changes in our services or legal requirements. Material changes will be communicated via the App or by email. Continued use of the App after updates constitutes acceptance of the revised policy.
...
Thank you for using Game Match. We are committed to honoring your privacy choices and providing clear controls over your data.
